...
- Implemented: real PDF/TXT parsing, page-aware source segments, selected source refs, lexical/page-aware retrieval v0, optional OpenAI embedding generation, pgvector writes, vector-first Chat retrieval with lexical fallback, and optional OpenAI chat generation with deterministic fallback.
- Not implemented yet: reranking, true server-side streaming, and chat memory.
